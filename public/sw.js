const CACHE='wtf-shed-happens-v5-2';
const CORE=['/','/index.html','/styles-v4.css','/styles-v5.css','/library-v5.css','/app-v4.js','/app-v5.js','/library-v5.js','/logo-v5.svg','/manifest.webmanifest','/icon.svg'];
